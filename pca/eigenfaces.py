...
t0 = time()
pca = RandomizedPCA(n_components=n_components, whiten=True).fit(X_train) #PCA being created
print("done in {0:.3f}s".format(time() - t0))

eigenfaces = pca.components_.reshape((n_components, h, w)) #PCs of the face data
...
clf = GridSearchCV(SVC(kernel='rbf', class_weight='balanced'), param_grid) #Line 98 on the original
